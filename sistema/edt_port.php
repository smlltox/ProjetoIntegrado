...
<html>
    <head>
        ...
        <script src="script.js"></script>
        <title>Editar Portfólio | SeivaBrutaTattoo</title>
    </head>
    <body>
        <div id="inicial">
            <div class="port">
                <h1 style="color: white">Potfólio:</h1>
                <button><a href="add_img.php">Adicionar Imagem</a></button>
                <?php
                // Query para obter todas imagehns
